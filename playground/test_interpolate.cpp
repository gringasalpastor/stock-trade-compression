...
BOOST_AUTO_TEST_CASE(test_interpolate) {
  ...
  double value = compress::interpolate::newton_interpolate(
      std::vector<double>({1.0, 1.3, 1.6, 1.9, 2.2}),
      std::vector<double>({.7651977, .6200860, .4554022, .2818186, .1103623}), 1.5);
