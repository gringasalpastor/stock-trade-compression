...
BOOST_AUTO_TEST_CASE(test_populate_size_map) {
  ...
  auto prefix_map    = compress::huffman::create_prefix_map(compress::huffman::make_huffman_tree(count_map, 36));
  auto canonical_map = compress::huffman::create_canonical_prefix_map(prefix_map);
