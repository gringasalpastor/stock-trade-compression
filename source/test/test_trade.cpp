...
BOOST_AUTO_TEST_CASE(trade) {
  ...
  t = compress::make_trade("6AH8", std::make_pair('F', '\n'), 'B', '0', 60306043, 60306043, 90510, "", 10);
  ...
  t = compress::make_trade("6AH8", std::make_pair('F', '\r'), 'B', '0', 60315666, 60315666, 314, "15", 20);
  BOOST_REQUIRE_EQUAL("6AH8,F,B,0,60315666,60315666,3.1415,20\r\n", t.to_csv());

  t = compress::make_trade("6AH8", std::make_pair('F', '\r'), 'B', '0', 60315666, 60315666, 135100, "", 20);
