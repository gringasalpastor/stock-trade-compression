...
BOOST_AUTO_TEST_CASE(parse_trade) {
  auto t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-0.14,115", '\n');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-3.1415,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-0.1415,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-14,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,89.5,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,1351,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-0.005,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-1,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-1.1,115", '\r');
  ...
  t = compress::parse_trade("GEM8-GEU8,F,A,0,60303042,60303043,-1.01,115", '\r');
  ...
  t = compress::parse_trade("GE:BF Z8-H9-M9,F,A,0,60303042,60303043,-1.01,115", '\r');
